...
# 
# basename:   base name of FITS file (basename*.fits)
# top_dir:    top of processing directory (needs to exist)
# search_dir: results directory (will be created if doesn't exist)
# fits_dir:   directory with one or more FITS files 
#
basename = "mag_meansub"
top_dir = '/hercules/results/rwharton/phased_gc/mag_test2'
...
time_sig  = 8     # The +/-sigma cutoff to reject time-domain chunks (d: 10)
...
rfi_otherflags = '' # Add any other additional flags or options here
...
ddm   = 20
dmcalls    = 1
dmspercall = 250    # Total num dm trials
nsub       = 512    # Needs to evenly divide total num channels
dsubDM     = 0.0
downsample = 1
prep_otherflags = '-ncpus 8 ' # other flags for prepsubband
...
dtrend    = 1    # Detrend factor 1-32 powers of two in 1000s (default=1)
